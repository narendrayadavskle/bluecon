...
function kapee_theme_style() {	
	...
	$style_options['navigation']['min_height'] = kapee_get_option( 'navigation-min-height', array( 'height' => '48' ) );
	...
	$theme_css = '
		...
		*/
		...
		.header-main{
			min-height:'.$style_options['header']['min_height']['height'].'px;
		}		
		...
		*/
		...
		.header-navigation .main-navigation ul.menu > li > a{
			min-height:'.$style_options['navigation']['min_height']['height'].'px;
		}
		.header-navigation .categories-menu-title{
			height:'.( ($style_options['navigation']['min_height']['height']) + 2 ).'px;
		}
		...
		*/
		...
		.header-sticky .main-navigation ul.menu > li > a{
			min-height:'.$style_options['header_sticky']['min_height']['height'].'px;
		}
		...
		*/
		#page-title{
			padding-top:'.$style_options['page_title']['padding']['padding-top'].'px;
			padding-bottom:'.$style_options['page_title']['padding']['padding-bottom'].'px;
		}	
