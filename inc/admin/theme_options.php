	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     		=> array(
			...
			array(
				...
				'subtitle'    	=> esc_html__( 'Enter copyright text.', 'kapee' ),
				'default'  		=> wp_kses_post('Kapee &copy; 2020 by <a href="https://presslayouts.com/" target="_blank">PressLayouts</a> All Rights Reserved.'),
				'required'		=> array( 'footer-copyright', '=', 1 )
            ),
			array(
                'id'       		=> 'payment-logo',
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     		=> 'slider',
                'desc'      	=> esc_html__( 'Apply opacity on out of stock product.', 'kapee' ),
                'default'   	=> .6,
                'min'       	=> .4,
                'step'      	=> .1,
                'max'       	=> 1,
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                'id'       		=> 'product-header',
                'type'     		=> 'switch',
                'title'    		=> esc_html__( 'Product Header', 'kapee' ),
				'subtitle'    	=> esc_html__( 'Show product header.', 'kapee' ),
                'default'  		=> 1,
                'on'       		=> esc_html__('Yes','kapee'),
                'off'      		=> esc_html__('No','kapee'),
            ),
			...
			array(
                ...
                'type'     		=> 'button_set',
                'title'    		=> esc_html__( 'Product Default View', 'kapee' ),
			...
			array(
                'id'       		=> 'product-sorting',
                'type'     		=> 'switch',
                'title'    		=> esc_html__('Product Sorting','kapee'),
				'subtitle' 	   	=> esc_html__( 'Show product sorting on shop page and archive pages.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
            ),			
			...
			array(
                ...
                'options'  	=> array(
                    'product-style-1' => array(
                        ...
                        'img' 	=> KAPEE_ADMIN_IMAGES . 'layout/product-1-hover.jpg',
                    ),
					'product-style-2' => array(
                        'alt' 	=> 'Products Hover Style 2',
                        'img' 	=> KAPEE_ADMIN_IMAGES . 'layout/product-2-hover.jpg',
                    ),
                    'product-style-3' => array(
                        'alt' 	=> 'Products Hover Style 3',
                        'img' 	=> KAPEE_ADMIN_IMAGES . 'layout/product-3-hover.jpg',
                    ), 
					'product-style-4' => array(
                        'alt' 	=> 'Products Hover Style 4',
                        'img' 	=> KAPEE_ADMIN_IMAGES . 'layout/product-4-hover.jpg',
                    ),
					'product-style-5' => array(
                        'alt' 	=> 'Products Hover Style 5',
                        'img' 	=> KAPEE_ADMIN_IMAGES . 'layout/product-5-hover.jpg',
                    ),
                ),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     		=> 'switch',
                'title'    		=> esc_html__('Quickview Button','kapee'),
                'subtitle'  	=> esc_html__( 'Show quickview button on shop page.', 'kapee' ),
                'on'       		=> esc_html__('Yes','kapee'),
				'off'      		=> esc_html__('No','kapee'),
				'default'  		=> 1,
            ),
			...
			array(
                ...
                'options'  		=> array(                    
                    'category-style-1' => array(
                        ...
                        'img' 	=> KAPEE_ADMIN_IMAGES . 'layout/category-1-hover.jpg',
                    ),
					'category-style-2' => array(
                        'alt' 	=> 'Category Style 2',
                        'img' 	=> KAPEE_ADMIN_IMAGES . 'layout/category-2-hover.jpg',
                    ),
                ),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     		=> 'button_set',
                'title'    		=> esc_html__( 'Products Columns', 'kapee' ),
	...
	Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
			...
			array(
                ...
                'type'     => 'switch',
                'title'    => esc_html__('Next/Prev Navigation','kapee'),
                'on'       => esc_html__('Show','kapee'),
				'off'      => esc_html__('Hide','kapee'),
				'default'  => 1,
            ),
