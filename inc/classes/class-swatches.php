...
if (!class_exists('Kapee_Woocommerce')) {
	...
	class Kapee_Woocommerce{
		...
		public function kapee_swatch_html($html,$terms,$options, $attribute_name, $selected_attributes){
			...
			foreach ( $terms as $term ) {
				$html .= $this->kapee_get_swatch_html($term,$selected_value,$attribute_name);
			}
			return $html;
		}
		
		/* Function get switch html*/
		public function kapee_get_swatch_html($term,$selected_value ='',$attribute_name = ''){
			$html 					= '';
			$prefix 				= KAPEE_PREFIX;
